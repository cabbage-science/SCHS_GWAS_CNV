...
count_cnvs_per_sliding_window <- function(cnv_df,bed_df,overlap=10,window_size=200000) {
  ...
  # Creating a combined df of sample IDs and copy numbers (default = 2)
  ...
  for(i in 1:length(sample_ids)) {
    ...
    #print(paste0("Analysis for sample number ",i," completed"))
  }
  return(output_df)
}
