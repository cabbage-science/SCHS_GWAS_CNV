...
write.table(CNV_matrix, "../results/CNV_matrix_indivs_windows_18Ksamples_200kbWindow_5nsnp_2.txt", quote = FALSE, sep = "\t", row.names = FALSE)
#write.table(CNV_matrix, "../results/CNV_matrix_indivs_windows_18Ksamples_100kbWindow_5nsnp.txt", quote = FALSE, sep = "\t", row.names = FALSE)
